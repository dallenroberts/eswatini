...
ingest_xlsm_filename = os.path.join('Data', 'calibration_ingest_form-Swaziland_ART_vars--UPDATED.xlsm')
...
template_files_dir = os.path.join(dir_path, 'InputsFor2020', 'Templates')
static_files_dir = os.path.join(dir_path, 'InputsFor2020', 'Static')
